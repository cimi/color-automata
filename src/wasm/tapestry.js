...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "tapestry.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "tapestry.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "tapestry.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "tapestry.js.mem" : null;
